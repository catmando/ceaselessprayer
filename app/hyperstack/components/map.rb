class Map < HyperComponent
  ...
  # def dims
  #   at 1421 zoom = 1.9 and height = 1000
  #   at 568 zoom = 0 and height = 300

  def zoom
    [(Window.height - 568) * (1.9 / (1421 - 568)), 0].max
  end

  def height
    [250 + (Window.height - 568) * (750 / (1421 - 568)), 150].max
  end
