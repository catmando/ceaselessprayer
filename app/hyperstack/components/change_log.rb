...
### Version 1.18, May 30, 2020

+ Prayers updated between Ancension and Pentecost
...
+ Increased wakeup time so map can load

### Version 1.13, May 12, 2020

+ Minimize refresh of recent cities
+ Cache Flags

### Version 1.12, May 12, 2020

+ Added error recovery and reporting
+ Refresh page when device wakes up from sleep

### Version 1.11, May 10, 2020

+ Updated Done page
+ Install instructions added to main menu
